    ...
    return (
        <div className="contact-us">
            ...
            <div className="contact-us__content">
                <div className="contact-us__content__email">
                    <svg className="contact-us__content__email__svg" viewBox="0 0 119.45 122.88" >
                    ...
                    <a className="contact-us__content__email__text"  href="mailto:caroline.cooney@scbcreative.co.uk">
                        caroline.cooney@scbcreative.co.uk
                    </a>
                    <a className="contact-us__content__email__text" href="mailto:james.cooney@scbcreative.co.uk">
                        james.cooney@scbcreative.co.uk
                    </a>
                </div>
                <div className="contact-us__content__logo-panel">
                    <p className="contact-us__content__logo-panel__text">Contact<br/>Us</p>
                    <LogoSVG className={"contact-us__content__logo-panel__logo"}/>
                </div>
                <div className="contact-us__content__address">
                    <a href="https://maps.app.goo.gl/MnRD6vztUorf9kRY9">
                        <svg viewBox="0 0 100 100" className="contact-us__content__address__svg">
